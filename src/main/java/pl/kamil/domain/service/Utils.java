...
public class Utils {
    ...
    public static double scaleToDomainRange(double norm, double min, double max) {
        return norm * (max - min) + min;
    }

    // skalowanie z [0;1] do -10 - 10
    public static double scaleToDomainRange(double norm) {
        return norm * (DOMAIN_X_END - DOMAIN_X_START) + DOMAIN_X_START;
    }

    // dowolnej na zakres -10 10
    public static double toDomain(double anyVal) {
